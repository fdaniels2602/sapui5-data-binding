		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Data Binding",
									"targetURL": "#mydatabindingdatabinding-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"mydatabindingdatabinding-display": {
								"semanticObject": "mydatabindingdatabinding",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=my.databinding.databinding",
									"url": sap.ui.require.toUrl("my/databinding/databinding")
								}
							}
						}
					}
